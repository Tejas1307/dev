...
* Three creatively named modes
    ...
    * (Placeholder name) Hard Mode:
        ...
        * Once the user finishes notetaking step, they are led to input screen where they can choose to add more inputs like lecture notes, or use their notes to generate the resources as mentioned above.
